...
Stopwatch Preview >> [preview](https://adhi2k.github.io/-Stopwatch-web-application/)
...
- **CSS**: Styling for the web page, including the video background and layout.
- **JavaScript**: Functionality of the stopwatch, including timing and split times.
